    ...
    let chatGptDisposable = vscode.commands.registerCommand('SmartCoder.chatGpt', async () => {
        ...
        try {
            vscode.window.withProgress({
                ...
                const panel = vscode.window.createWebviewPanel('chatGPTResult', 'ChatGPT Result', vscode.ViewColumn.Beside, {
                    enableScripts: true,
    ...
    let generateTestCaseDisposable = vscode.commands.registerCommand('SmartCoder.generateTestCase', async () => {
        ...
        try {
            vscode.window.withProgress({
                ...
                const response = await axios_1.default.post('https://api.openai.com/v1/engines/davinci/completions', {
